...
func initVersion() {
	...
	value, err := httplib.Get(GhProxy + "https://raw.githubusercontent.com/sxsto/dmm/main/models/version.go").String()
	if err != nil {
		logs.Info("更新版本的失败")
	} else {
